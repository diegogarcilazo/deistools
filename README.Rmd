...
**report_useless()**: Crea un reporte con 4 tablas que nos permiten evaluar el peso y la distribución de los códigos poco útiles.
...
**list_useless**: Genera listas con los registros de códigos poco útiles.
